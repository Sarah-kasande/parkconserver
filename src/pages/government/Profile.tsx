...
import { User, Mail, Shield, Key, Briefcase } from 'lucide-react';
...
const GovernmentProfile = () => {
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      const response = await axios.put(`${API_URL}/government/profile`, {
      ...
      if (avatarFile) {
        ...
        const avatarResponse = await axios.post(`${API_URL}/government/avatar`, formData, {
          headers: {
  ...
  const handleChangePassword = async () => {
    ...
    setIsSaving(true);
    try {
      await axios.put(`${API_URL}/government/password`, {
        currentPassword,
        newPassword,
        confirmPassword,
      }, {
  ...
  const handleDeleteAccount = async () => {
    ...
    setIsSaving(true);
    try {
      await axios.delete(`${API_URL}/government/account`, {
        headers: { 'Authorization': `Bearer ${localStorage.getItem('token')}` }
      });
      logout();
      navigate('/login');
