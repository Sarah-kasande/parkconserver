...
const AuditorProfile = () => {
  ...
  const [profileForm, setProfileForm] = useState({
    ...
    email: '',
    phone: '',
    jobTitle: 'Auditor', // Fixed for auditor role
  });
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      const response = await axios.put(`${API_URL}/auditor/profile`, {
      ...
      if (avatarFile) {
        ...
        const avatarResponse = await axios.post(`${API_URL}/auditor/avatar`, formData, {
          headers: {
  ...
  const handleChangePassword = async () => {
    ...
    setIsSaving(true);
    try {
      await axios.put(`${API_URL}/auditor/password`, {
        currentPassword,
        newPassword,
        confirmPassword,
      }, {
  ...
  const handleDeleteAccount = async () => {
    ...
    setIsSaving(true);
    try {
      await axios.delete(`${API_URL}/auditor/account`, {
        headers: { 'Authorization': `Bearer ${localStorage.getItem('token')}` }
      });
      logout();
      navigate('/login');
    ...
    <SidebarProvider>
      <div className="flex min-h-screen bg-gray-50 w-full">
        ...
        <div className="flex-1">
          <DashboardHeader title="Auditor Profile" subtitle="Manage your account settings" />
